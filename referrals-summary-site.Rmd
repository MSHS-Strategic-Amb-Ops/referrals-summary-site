...
scheduling_data_raw <- as.data.frame(readRDS("/nfs/data/Applications/Ambulatory/Data_Updated/historical_data.rds")) %>%
  ...
  filter(!is.na(Campus)) %>%
  filter(Campus %in% c("NETWORK","MSM","MSH-MSDFP","MSW","MSBI","MSUS","MSH- AMBULATORY CARE","MSDMG", "MSHP"))
...
mshs_sites <- c("MSBI", "MSDMG", "MSH- Ambulatory Care", "MSH-MSDFP", 
  ...
  monthly_avg <- referral_vol %>%
    filter(ReceivedByDept != "*Unspecified") %>%
    filter(ReceivedBySite %in% mshs_sites) %>%
    filter(createdYear == current_year) %>%
    # filter(StartInstant < as.Date("2023-03-01") & StartInstant >= as.Date("2022-09-01", "%Y-%m-%d")) %>%
    group_by(ReferredToDepartmentSpecialty, createdMonthYear) %>%
    summarise(total = n()) %>%
    group_by(ReferredToDepartmentSpecialty) %>%
    mutate(avg = round(mean(total))) %>%
    group_by(ReferredToDepartmentSpecialty, avg) %>%
...
sending_vol_site_month <- function(site, monthYear, yearMonth){
  ...
  Missing <- setdiff(nms, names(referral_sending_vol_site_data_month))  # Find names of missing columns
  referral_sending_vol_site_data_month[Missing] <- 0                    # Add them, filled with '0's
  referral_sending_vol_site_data_month <- referral_sending_vol_site_data_month[nms]
...
referral_sending_vol_specialty_data_site_trend <- function(site){
  ...
  # Add Missing ApptStatusFinal
  nms <- c("SentBySpecialty", "createdMonthYear", 
          "Pending", "Arrived", "Canceled", "Scheduled", "No Show")   # Vector of columns you want in this data.frame

  Missing <- setdiff(nms, names(referral_sending_vol_specialty_data_site_trend))  # Find names of missing columns
  referral_sending_vol_specialty_data_site_trend[Missing] <- 0                    # Add them, filled with '0's
  referral_sending_vol_specialty_data_site_trend <- referral_sending_vol_specialty_data_site_trend[nms]
...
reactable(
  ...
  columnGroups = list(
    colGroup(name = "", columns = c("ReferredToDepartmentSpecialty", "ReceivedByDept"),
             ...
             sticky = "left"),
    colGroup(name = paste0("Referrals Received ",reporting_year, " YTD"), columns = c("Total", "Arrived", "Pending", "conversion_rate", "completion_rate"),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      ...
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msbi', 'Referrals Sent')"
    ),
...
reactable(
  ...
  columnGroups = list(
    colGroup(name = "", columns = c("SentBySpecialty", "SentByDept"),
             headerStyle = list(color = "black", fontSize = "15px"),
             sticky = "left"),
    colGroup(name = paste0("Referrals Sent ",reporting_year, " YTD"), columns = c("Total", "Arrived", "Pending", "avg_referrals", "conversion_rate", "completion_rate"),
             headerStyle = list(color = "#210070", fontSize = "15px"))
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msbi-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msbi-current', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msbi', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msbi-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msbi-current', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msdmg', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msdgm-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msdmg-current', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msdmg', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msdmg-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msdmg-current', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msh-amb', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msh-amb-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msh-amb', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msh-amb-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msh-amb-current', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msh-msdfp', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msh-msdfp-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msh-msdfp-current', 'Referrals Sent')"
    ),  
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msh-msdfp', 'Referrals Received')"
    ),  
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msh-msdfp-last', 'Referrals Received')"
    ),  
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msh-msdfp-current', 'Referrals Received')"
    ),  
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msm', 'Referrals Sent')"
    ),  
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msm-last', 'Referrals Sent')"
    ),  
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msm-current', 'Referrals Sent')"
    ),  
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msm', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msm-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msm-current', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msus', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msus-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msus-current', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
    ...
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msus', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msus-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
    ...
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msus-current', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msw', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-msw-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msw', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msw-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-msw-current', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-network', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-network-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-network-current', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-network', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-network-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-network-current', 'Referrals Received')"
    ),
...
<!--     tags$button( -->
<!--       tagList(fontawesome::fa("download"), "Download Table"), -->
<!--       onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-oncology', 'Referrals Sent')" -->
<!--     ), -->
...
<!--     tags$button( -->
<!--       tagList(fontawesome::fa("download"), "Download Table"), -->
<!--       onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-oncology-last', 'Referrals Sent')" -->
<!--     ), -->
...
<!--     tags$button( -->
<!--       tagList(fontawesome::fa("download"), "Download Table"), -->
<!--       onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-oncology-current', 'Referrals Sent')" -->
<!--     ), -->
...
<!--     tags$button( -->
<!--       tagList(fontawesome::fa("download"), "Download Table"), -->
<!--       onclick = "Reactable.downloadDataCSV('referrals-expansion-table-oncology', 'Referrals Received')" -->
<!--     ), -->
...
<!--     tags$button( -->
<!--       tagList(fontawesome::fa("download"), "Download Table"), -->
<!--       onclick = "Reactable.downloadDataCSV('referrals-expansion-table-oncology-last', 'Referrals Received')" -->
<!--     ), -->
...
<!--     tags$button( -->
<!--       tagList(fontawesome::fa("download"), "Download Table"), -->
<!--       onclick = "Reactable.downloadDataCSV('referrals-expansion-table-oncology-current', 'Referrals Received')" -->
<!--     ), -->
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-mshp', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-mshp-last', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-sending-expansion-table-mshp-current', 'Referrals Sent')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-mshp', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-mshp-last', 'Referrals Received')"
    ),
...
htmltools::browsable(
  ...
  #   ),
   ...
   tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('referrals-expansion-table-mshp-current', 'Referrals Received')"
    ),
