...
# readRDS("waitTime_site_specialty_dept_180days.rds")
# readRDS("waitTime_site_specialty_dept_trend.rds")
# readRDS("new_access_site_specialty_dept_180days.rds")
# readRDS("new_access_site_specialty_dept_trend.rds")
# readRDS("volume_site_specialty_dept_180days.rds")
# readRDS("volume_site_specialty_dept_trend.rds")
...
mshs_sites <- c("MSBI", "MSDMG", "MSH- Ambulatory Care", "MSH-MSDFP", 
  ...
  referral_vol_site_data_mshs <- referral_vol_site_data_mshs %>%
    ...
    dplyr::select(ReferredToDepartmentSpecialty, ReceivedByDept, ReceivedByDepID, Total, Arrived,  Pending, conversion_rate, completion_rate)
...
received_vol_site_month <- function(site, monthYear, yearMonth){
  ...
  referral_vol_site_data_month <- referral_vol %>%
    ...
    filter(ReferredToDepartmentSpecialty != "*Unspecified") %>%
    filter(ReceivedBySite == site) %>%
    filter(createdMonthYear == full_monthYear) %>%
    group_by(ReferredToDepartmentSpecialty, ReceivedByDept, ReceivedByDepID, ApptStatusFinal) %>%
    summarise(total_vol = n()) %>%
    pivot_wider(names_from = ApptStatusFinal,
                values_from = total_vol,
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-mshs-1')"
    ),
...
reactable(
  ...
  columns = list(
    ...
    Pending = colDef(
      name = "Referrals without Scheduled Appointments",
      maxWidth = 100,
      headerStyle = list(background = "#210070", color = "white", fontWeight = "Bold", fontSize = "14px"),
      aggregate = "sum",
      # footer = JS("function(column, state) {
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-mshs-2')"
    ),

reactable(
  referral_vol_site_data_mshs_month(full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-mshs-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left", 
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-mshs-3')"
    ),

reactable(
  referral_vol_site_data_mshs_month(current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-mshs-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left", 
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
### MSBI Sep 2022-`r reporting_year` YTD
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msdmg-1')"
    ),

reactable(
  received_vol_site_ytd("MSDMG"),
  elementId = "referrals-expansion-table-msdmg-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msdmg-2')"
    ),

reactable(
  received_vol_site_month("MSDMG", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-msdmg-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msdmg-3')"
    ),

reactable(
  received_vol_site_month("MSDMG", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-msdmg-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msh-amb-1')"
    ),

reactable(
  received_vol_site_ytd("MSH- Ambulatory Care"),
  elementId = "referrals-expansion-table-msh-amb-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msh-amb-2')"
    ),

reactable(
  received_vol_site_month("MSH- Ambulatory Care", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-msh-amb-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
### `r current_monthYear_label` MTD
```{r MSH- Ambulatory Care Current Month Total Referrals Received Output, echo = FALSE, warning = FALSE, message = FALSE, fig.width=12}
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msh-amb-3')"
    ),

reactable(
  received_vol_site_month("MSH- Ambulatory Care", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-msh-amb-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msh-msdfp-1')"
    ),

reactable(
  received_vol_site_ytd("MSH-MSDFP"),
  elementId = "referrals-expansion-table-msh-msdfp-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msh-msdfp-2')"
    ),

reactable(
  received_vol_site_month("MSH-MSDFP", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-msh-msdfp-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msh-msdfp-3')"
    ),

reactable(
  received_vol_site_month("MSH-MSDFP", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-msh-msdfp-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msm-1')"
    ),

reactable(
  received_vol_site_ytd("MSM"),
  elementId = "referrals-expansion-table-msm-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msm-2')"
    ),

reactable(
  received_vol_site_month("MSM", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-msm-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msm-3')"
    ),

reactable(
  received_vol_site_month("MSM", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-msm-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msus-1')"
    ),

reactable(
  received_vol_site_ytd("MSUS"),
  elementId = "referrals-expansion-table-msus-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msus-2')"
    ),

reactable(
  received_vol_site_month("MSUS", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-msus-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msus-3')"
    ),

reactable(
  received_vol_site_month("MSUS", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-msus-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msw-1')"
    ),

reactable(
  received_vol_site_ytd("MSW"),
  elementId = "referrals-expansion-table-msw-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msw-2')"
    ),

reactable(
  received_vol_site_month("MSW", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-msw-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-msw-3')"
    ),

reactable(
  received_vol_site_month("MSW", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-msw-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-network-1')"
    ),

reactable(
  received_vol_site_ytd("Network"),
  elementId = "referrals-expansion-table-network-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-network-2')"
    ),

reactable(
  received_vol_site_month("Network", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-network-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-network-3')"
    ),

reactable(
  received_vol_site_month("Network", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-network-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-oncology-1')"
    ),

reactable(
  received_vol_site_ytd("Oncology"),
  elementId = "referrals-expansion-table-oncology-1",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-oncology-2')"
    ),

reactable(
  received_vol_site_month("Oncology", full_monthYear, full_yearMonth),
  elementId = "referrals-expansion-table-oncology-2",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
...
htmltools::browsable(
  tagList(
    tags$button(
      "Expand/collapse all",
      onclick = "Reactable.toggleAllRowsExpanded('referrals-expansion-table-oncology-3')"
    ),

reactable(
  received_vol_site_month("Oncology", current_monthYear, current_yearMonth),
  elementId = "referrals-expansion-table-oncology-3",
  style = list(fontFamily = 'Calibri',
                 fontSize = '14px'),
    defaultColDef = colDef(align = "left",
                           headerStyle = list(fontWeight = "Bold", fontSize = "14px"),
