...
mshs_sites <- c("MSBI", "MSDMG", "MSH- Ambulatory Care", "MSH-MSDFP", 
  ...
  # referral_vol_site_data_mshs$urgent_vol <- referral_vol_urgent_site_data_mshs$urgent_vol[match(referral_vol_site_data_mshs$ReceivedByDepID, referral_vol_urgent_site_data_mshs$ReceivedByDepID)]
  # 
  # referral_vol_site_data_mshs <- referral_vol_site_data_mshs %>%  
  #   dplyr::select(ReferredToDepartmentSpecialty, ReceivedByDept, ReceivedByDepID, Total, Arrived,  Pending, urgent_vol, conversion_rate, completion_rate)
  # 
