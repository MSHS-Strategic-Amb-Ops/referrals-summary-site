...
full_monthYear <- format((lubridate::floor_date(max_appt_date, unit = "month")-1), "%Y-%m")
...
current_monthYear <- format((lubridate::floor_date(max_appt_date, unit = "month")), "%Y-%m")
...
mshs_sites <- c("MSBI", "MSDMG", "MSH- Ambulatory Care", "MSH-MSDFP", 
  ...
  referral_vol_site_data_mshs <- referral_vol_site_data_mshs %>%
    ...
    adorn_totals("row", name = paste(ifelse(length(site_input) >2, "MSHS", site_input), "Total")) %>%
...
reactable(
  ...
  columnGroups = list(
    ...
    colGroup(name = paste0("Referrals Received from Sep 2022 - ",reporting_year, " YTD"), columns = c("Total", "Arrived", "Pending", "conversion_rate", "completion_rate"),
             headerStyle = list(color = "#212070", fontSize = "15px")),
